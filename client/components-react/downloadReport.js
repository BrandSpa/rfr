...
const DownloadReport = React.createClass({
  ...
  render() {
    ...
    const { texts, countries, country, languages, language } = this.props;
        ...
        <div className="row">
          ...
          <div className="col-md-5" style={{ float: "none", margin: "0 auto" }}>
            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="input-container">
                <label className="color-red">
                  ...
                  <span
                    className={
                      errors.name
                        ? "input-container__error input-container__error-show"
              ...
              <div className="input-container">
                ...
                >
                  {Object.keys(languages).map((lang, i) => (
                    <option key={i} value={languages[lang].slug}>
                      {languages[lang].name}
                    </option>
                  ))}
                </select>
              ...
              <button
                className="button title-uppercase"
