...
<div class="hidden">
<?php echo 'office: '. get_option('office_redirect_' . str_replace(' ', '_', getOfficeCountry()) ); ?>
</div>
<body id="acn_reports">
...
<div class="nav">
  <div class="nav__logo" style="height: 120px;background: #fff">
    ...
    <a href="<?php echo $home ?>">
      ...
      <?php if( !empty( get_option("logo_" . str_replace(' ', '_', getOfficeCountry())  )) ): ?>
        <img src='<?php echo bs_logo_url(); ?>'  alt="acn logo" class="img-responsive" width="200"  />
      <?php else: ?>
  ...
  <a href="<?php echo $home ?>">
    <h4 class="nav__subtitle">
      <?php echo gett('RELIGIOUS <span class="color-red">FREEDOM</span><br>REPORT', true) ?> 2016
    </h4>
  </a>
